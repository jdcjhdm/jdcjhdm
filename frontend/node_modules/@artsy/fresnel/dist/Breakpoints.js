...
exports.Breakpoints = exports.BreakpointKey = void 0;
...
exports.BreakpointKey = BreakpointKey;

(function (BreakpointKey) {
  BreakpointKey["at"] = "at";
  BreakpointKey["lessThan"] = "lessThan";
  BreakpointKey["greaterThan"] = "greaterThan";
  BreakpointKey["greaterThanOrEqual"] = "greaterThanOrEqual";
  BreakpointKey["between"] = "between";
})(BreakpointKey || (exports.BreakpointKey = BreakpointKey = {}));
...
function () {
  _createClass(Breakpoints, null, [{
    ...
    value: function validKeys() {
      return [BreakpointKey.at, BreakpointKey.lessThan, BreakpointKey.greaterThan, BreakpointKey.greaterThanOrEqual, BreakpointKey.between];
    }
  }]);
  ...
  function Breakpoints(_breakpoints) {
    ...
    this._mediaQueries = (_this$_mediaQueries = {}, _defineProperty(_this$_mediaQueries, BreakpointKey.at, this._createBreakpointQueries(BreakpointKey.at, this._sortedBreakpoints)), _defineProperty(_this$_mediaQueries, BreakpointKey.lessThan, this._createBreakpointQueries(BreakpointKey.lessThan, this._sortedBreakpoints.slice(1))), _defineProperty(_this$_mediaQueries, BreakpointKey.greaterThan, this._createBreakpointQueries(BreakpointKey.greaterThan, this._sortedBreakpoints.slice(0, -1))), _defineProperty(_this$_mediaQueries, BreakpointKey.greaterThanOrEqual, this._createBreakpointQueries(BreakpointKey.greaterThanOrEqual, this._sortedBreakpoints)), _defineProperty(_this$_mediaQueries, BreakpointKey.between, this._createBreakpointQueries(BreakpointKey.between, betweenCombinations)), _this$_mediaQueries);
  }
  ...
  _createClass(Breakpoints, [{
    ...
    get: function get() {
      return Array.from(this._mediaQueries[BreakpointKey.at].entries()).reduce(function (acc, _ref5) {
